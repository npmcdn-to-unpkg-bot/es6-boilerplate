...
apiGenerator.expose = function(model, _opts_) {
    ...
    function configureEndpoints() {
        console.log("Create EndPoint for GET: " + options.apiRoot + opts.endpointName);
        app.get(options.apiRoot + opts.endpointName, function(req, res, next) {
            var mod;
            console.log("CALLED: " + options.apiRoot + opts.endpointName);
            if(req.query.where) {
                var w;
                try {
        ...
        console.log("Create EndPoint for GET: " + options.apiRoot + opts.endpointName+ '/:identifier');
        ...
        console.log("Create EndPoint for GET: " + options.apiRoot + opts.endpointName+ '/:identifier'+ '/:identifier/:relation');
        ...
        console.log("Create EndPoint for POST: " + options.apiRoot + opts.endpointName);
        ...
        console.log("Create EndPoint for POST: " + options.apiRoot + opts.endpointName+ '/:identifier');
        ...
        console.log("Create EndPoint for DELETE: " + options.apiRoot + opts.endpointName+ '/:identifier');
